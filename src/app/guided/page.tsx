...
export default function GuidedPage() {
  ...
  const [networks, setNetworks] = useState<Array<{ id: string; chip: string; title: string; summary: string }>>([]);
